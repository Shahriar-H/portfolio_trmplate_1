...
const dataSet = {
  '#About':{
    title:'About Me',
    subtitle:"Lorem, ipsum dolor sit amet consectetur adipisicing elit. Illo tenetur omnis perferendis, aperiam architecto doloribus dolorem laborum nemo voluptatibus ipsam!"
  },
  '#Expertise':{
    title:'Expertise',
    subtitle:"Lorem, ipsum dolor sit amet consectetur adipisicing elit. Illo tenetur omnis perferendis, aperiam architecto doloribus dolorem laborum nemo voluptatibus ipsam!"
...
function showHeadePage(selectedid){
  $("#headerTitle").removeClass("d-none")
  $("#headerTitle").fadeOut("fast")
  setTimeout(() => {
    $("#headerTitle").fadeIn("fast")
    const selectedData = dataSet[selectedid]
    console.log(selectedData);
    document.querySelector('#mainTitle').innerHTML=selectedData['title']
    document.querySelector('#subtitle').innerHTML=selectedData['subtitle']
  }, 100);
}
function HideHeaderPage(){
  // $("#headerTitle").addClass("d-none")
  $("#headerTitle").fadeOut("fast")
}
function showPage(e) {
  console.log(e);
  ...
  (lockNav = !0),
    ...
    showBackButton(),
    showHeadePage(e),
    $("#pagination").addClass("paginationFlex")
...
function hidePage(e) {
  ...
  movePage(0),
    ...
    e ||
      ...
      $("#pagination").removeClass("paginationFlex"),
        ...
        function () {
          $("#layer" + e).removeClass("dim"),
            1 > --e &&
              (clearInterval(t),
              $("#vignette").addClass("fadeOut"),
              setTimeout(showName, fastStart ? 100 : 150));
        },
        fastStart ? 100 : 150
      );
